        ...
        return (
            <li> 
                ...
                <select onChange={addChoice} id={index}>
                     ...
                     <option type='radio' id='choice1' value={question.choice1}>{question.choice1}</option>
                   
                     <option type='radio' id='choice2' value={question.choice2}>{question.choice2}</option>
                    
                     <option type='radio' id='choice3' value={question.choice3}>{question.choice3}</option>
